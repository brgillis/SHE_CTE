...
CMD="E-Run SHE_CTE 0.2 SHE_CTE_FitPSFs --data_images $DATA_IM --detections_tables $DTC_TAB --astrometry_products $AST_PROD --aocs_time_series_products $AOCS_PROD --mission_time_products $MT_PROD --psf_calibration_products $PSF_CAL --psf_images_and_tables $PSF_IMTAB --workdir /home/user/euclid-ial/workspace/tests/she_analysis --logdir /home/user/euclid-ial/workspace/tests/she_analysis/logdir"
...
CMD="E-Run SHE_CTE 0.2 SHE_CTE_ValidateShear --shear_estimates_product $SE_PROD --shear_estimates_listfile $SE_LF --shear_validation_statistics_table $SV_TAB --validated_shear_estimates_table $VSE_TAB --workdir /home/user/euclid-ial/workspace/tests/she_analysis --logdir /home/user/euclid-ial/workspace/tests/she_analysis/logdir"
