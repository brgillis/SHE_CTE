...
def defineSpecificProgramOptions():
    ...
    parser.add_argument('--psf_calibration_products', type=str, default=None,
    ...
    parser.add_argument('--aocs_time_series_products', type=str, default=None,
                        help="Desired name of listfile containing mock aocs time series products.")
    
    parser.add_argument('--mission_time_products', type=str, default=None,
    ...
    parser.add_argument('--shear_validation_statistics_table', type=str, default=None,
